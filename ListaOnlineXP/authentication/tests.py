...
class CourseTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.student1 = Student.objects.create(name=u"Steven Koiti Tsukamoto", nusp=u"6431089", user=User.objects.get(id=2))
        self.student2 = Student.objects.create(name=u"Thiago da Silva Pinheiro", nusp=u"6797000", user=User.objects.get(id=3))
        self.student3 = Student.objects.create(name=u"Bruno Milan Perfetto", nusp=u"123456", user=User.objects.get(id=4))
    ...
    def testStudentDB(self):
        ...
        self.assertEqual(Student.objects.get(name=u"Steven Koiti Tsukamoto").user.username, u"koiti")
        self.assertEqual(Student.objects.get(name=u"Thiago da Silva Pinheiro").user.username, u"tsp")
        self.assertEqual(Student.objects.get(name=u"Bruno Milan Perfetto").user.username, u"milan")
